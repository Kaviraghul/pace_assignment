...
ThemeData getApplicationTheme() {
  final theme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1 : getSemiBoldStyle(color: ColorManager.white, fontSize: FontSize.s29),
      subtitle1 : getMediumStyle  (color: ColorManager.halfWhite, fontSize: FontSize.s20),
      subtitle2 : getMediumStyle  (color: ColorManager.lightGray, fontSize: FontSize.s12),
      caption   : getRegularStyle (color: ColorManager.halfWhite, fontSize: FontSize.s29),
      bodyText1 : getRegularStyle (color: ColorManager.lightGray, fontSize: FontSize.s14),
    ),
